...
def get_order_status(order_id: str) -> Optional[Dict]:
    """
     ...
     Returns:
       Optional[Dict]: 包含订单状态信息的字典，如果订单不存在则返回None
     """
...
if __name__ == '__main__':
    # 测试代码
    print(get_order_status('OD1001'))
    print(return_order('OD1001'))
    print(complain_order('OD1001', '商品质量问题'))
